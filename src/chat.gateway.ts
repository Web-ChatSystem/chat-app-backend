...
@WebSocketGateway({
  cors: {
    origin: ["http://localhost:4173", "https://chat-app-frontend-v2-9xdq.vercel.app", "https://chat-app-frontend-myn0.onrender.com", "https://www.hust-cv-thson-20210744-web-app.id.vn"],
  },
})
